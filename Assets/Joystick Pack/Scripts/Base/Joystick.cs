...
public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public float lastNonZeroHorizontal;
    public float lastNonZeroVertical;
    ...
    public float ThrowTime
    {
        ...
        set {
            if (throwTime == value) return;
            throwTime = value;
            if (OnDragFinish != null)
                OnDragFinish(throwTime);
        }
    }
